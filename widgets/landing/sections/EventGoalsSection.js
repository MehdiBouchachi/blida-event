      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 space-y-10 sm:space-y-14 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[64px_1fr] md:grid-cols-[80px_1fr] gap-6 sm:gap-8 items-start">
            <div className="mx-auto sm:mx-0 flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-xl bg-blue-50 text-blue-600">
          ...
          {/* Objective 2 */}
          <div className="grid grid-cols-1 sm:grid-cols-[64px_1fr] md:grid-cols-[80px_1fr] gap-6 sm:gap-8 items-start">
            <div className="mx-auto sm:mx-0 flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-xl bg-emerald-50 text-emerald-600">
          ...
          {/* Objective 3 */}
          <div className="grid grid-cols-1 sm:grid-cols-[64px_1fr] md:grid-cols-[80px_1fr] gap-6 sm:gap-8 items-start">
            <div className="mx-auto sm:mx-0 flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-xl bg-indigo-50 text-indigo-600">
